...
import type { Analytics, DetailedStats } from '../types'
        ...
        {loading ? (
          ...
          <div className="detailed-stats">
            <div className="stats-summary">
              ...
              <p><strong>URL:</strong> {detailedStats.url.originalUrl}</p>
              <p><strong>Создано:</strong> {formatDate(detailedStats.url.createdAt)}</p>
              <p><strong>Всего кликов:</strong> {detailedStats.url.clickCount}</p>
            </div>
          ...
          <div className="analytics">
            <div className="analytics-summary">
              ...
              <p><strong>URL:</strong> {analytics.originalUrl}</p>
              <p><strong>Создано:</strong> {formatDate(analytics.createdAt)}</p>
              <p><strong>Всего кликов:</strong> {analytics.clickCount}</p>
            </div>
